...
jQuery(document).ready(function($) {
  ...
  $('#wp-blow-tabs')
    .tabs({
      ...
      activate: function(event, ui) {
        localStorage.setItem('wp-blow-tabs', $('#wp-blow-tabs').tabs('option', 'active'));
      },
      active: localStorage.getItem('wp-blow-tabs') || 0
    })
    .show();

  // helper for swithcing tabs & linking anchors in different tabs
  $('.tools_page_wp-blow').on('click', '.change-tab', function(e) {
    e.preventDefault();

    $('#wp-blow-tabs').tabs('option', 'active', $(this).data('tab'));
  ...
  $('.tools_page_wp-blow').on('click', '.scrollto', function(e) {
    e.preventDefault();
  ...
  $('.tools_page_wp-blow').on('click', '.button.dropdown-toggle', function(e) {
    e.preventDefault();
  ...
  // delete transients
  $('.tools_page_wp-blow').on('click', '#delete-transients', 'click', function(e) {
    e.preventDefault();
  ...
  // delete uploads
  $('.tools_page_wp-blow').on('click', '#delete-uploads', 'click', function(e) {
    e.preventDefault();
  ...
  // blow theme options (mods)
  $('.tools_page_wp-blow').on('click', '#blow-theme-options', 'click', function(e) {
    e.preventDefault();

    run_tool(this, 'blow_theme_options');

    return false;
  }); // blow theme options

  // delete themes
  $('.tools_page_wp-blow').on('click', '#delete-themes', 'click', function(e) {
    e.preventDefault();
  ...
  // delete plugins
  $('.tools_page_wp-blow').on('click', '#delete-plugins', 'click', function(e) {
    e.preventDefault();
  ...
  // drop custom tables
  $('.tools_page_wp-blow').on('click', '#drop-custom-tables', 'click', function(e) {
    e.preventDefault();
  ...
  $('.tools_page_wp-blow').on('click', '#truncate-custom-tables', 'click', function(e) {
    e.preventDefault();
  ...
  $('.tools_page_wp-blow').on('click', '#delete-htaccess', 'click', function(e) {
    e.preventDefault();
  ...
  $('#wpr-snapshots').on('click', '.compare-snapshot', 'click', function(e) {
    ...
    $.get({
      url: ajaxurl,
      data: {
        action: 'wp_blow_run_tool',
        _ajax_nonce: wp_blow.nonce_run_tool,
      ...
      .done(function(data) {
        if (data.success) {
          ...
          swal({
            type: 'error',
            title: wp_blow.documented_error + ' ' + data.data
          });
        }
      })
      .fail(function(data) {
        swal({ type: 'error', title: wp_blow.undocumented_error });
      });
  ...
  // create snapshot
  $('.tools_page_wp-blow').on('click', '.create-new-snapshot', 'click', function(e) {
    e.preventDefault();
    ...
    swal({
      ...
      cancelButtonText: wp_blow.cancel_button,
      width: 600
    }).then(result => {
  ...
  $('body.tools_page_wp-blow').on('click', '.header-row', function(e) {
    e.preventDefault();
  ...
  function run_tool(button, tool_name, extra_data) {
    var confirm_title = $(button).data('confirm-title') || wp_blow.confirm_title;
  ...
  $('#wp_blow_form').on('submit', function(e, confirmed) {
    if (!confirmed) {
      $('#wp_blow_submit').trigger('click');
      e.preventDefault();
      return false;
    }
  ...
  $('#wp_blow_submit').click(function(e) {
    if ($('#wp_blow_confirm').val() !== 'blow') {
      swal({
        title: wp_blow.invalid_confirmation_title,
        text: wp_blow.invalid_confirmation,
        type: 'error',
        confirmButtonText: wp_blow.ok_button
      });
    ...
    message = wp_blow.confirm1 + '<br>' + wp_blow.confirm2;
    swal({
      title: wp_blow.confirm_title_blow,
      type: 'question',
      html: message,
      showCancelButton: true,
      focusConfirm: false,
      focusCancel: true,
      confirmButtonText: wp_blow.confirm_button,
      cancelButtonText: wp_blow.cancel_button,
      confirmButtonColor: '#dd3036',
      width: 600
    }).then(result => {
      if (result.value === true) {
        block_ui(wp_blow.doing_blow);
        $('#wp_blow_form').trigger('submit', true);
      }
    });
  ...
  $('.tools_page_wp-blow').on('click', '.toggle-card', function(e, skip_anim) {
    e.preventDefault();
    ...
    cards = localStorage.getItem('wp-blow-cards');
    if (cards == null) {
      cards = new Object();
    } else {
    ...
    localStorage.setItem('wp-blow-cards', JSON.stringify(cards));
  ...
  $('.wpr-dismiss-notice').on('click', function(e) {
    ...
    $.get(ajaxurl, {
      ...
      _ajax_nonce: wp_blow.nonce_dismiss_notice,
  ...
  $('.submit-survey').on('click', function(e) {
    ...
    $.post(ajaxurl, {
      ...
      _ajax_nonce: wp_blow.nonce_submit_survey,
      action: 'wp_blow_submit_survey'
    });
  ...
  $('.tools_page_wp-blow').on('click', '.open-webhooks-dialog', function(e) {
    $(this).blur();
  ...
  $('#webhooks-dialog').dialog({
    ...
    open: function(event, ui) {
      ...
      $(this)
        ...
        .html(wp_blow.webhooks_dialog_title);
    },
    close: function(event, ui) {},
    autoOpen: false,
    closeOnEscape: true
